     ...
     for (BitacoraDto a : registrosBitacora.consultar()) {
       ...
       /* for (Otros a: daoPersonal.consultarOtros()) {
        ...
        //Pestaña de Bitacora
						...
						scrollBitacora.setBounds(10, 202, 935, 351);
						...
						lblUsuario.setBounds(350, 10, 80, 26);
						panelFondoParking.add(lblUsuario);
						
						txtUsuario = new JTextField();
						txtUsuario.setEditable(false);
						txtUsuario.setColumns(10);
						txtUsuario.setBounds(435, 9, 186, 26);
						...
						btnAgregar.addActionListener(new ActionListener() {
						    public void actionPerformed(ActionEvent arg0) {
						        ...
						        if (txtCorbatin.getText() != null && !txtCorbatin.getText().equals("")) {
						            ...
						            //Con el personalDao(metodo getCorbatinById) se manda a traer el corbatin con el numCorbatin ingresado
						            //todos los datos se guardan en corbatin
						            corbatin = personalDao.getCorbatinById(numCorbatin);
						            
						            //corbatin ahora contiene los datos de ese corbatin y ya se puede hacer consultas
						            ...
						            if (estatusCorbatin.getIdEstatus() != 1) {
						                JOptionPane.showMessageDialog(null, "El estatus del corbatín no es válido.", "Advertencia", JOptionPane.WARNING_MESSAGE);
						            } else {
						             ...
						             // Obtener la fecha y hora actual
						                ...
						                if (personalDao.crearBitacora(registroBitacora)) {
						                    ...
						                    JOptionPane.showMessageDialog(null, "Se subió el registro", "Aviso", JOptionPane.INFORMATION_MESSAGE);
						                    	
						                }else {
						                        JOptionPane.showMessageDialog(null, "Error al crear el registro", "Aviso", JOptionPane.ERROR_MESSAGE);
						                }
						            }
						        }
						    }
						    ...
						    public void actionPerformed(ActionEvent arg0) {
						        ...
						        try {
						            ...
						            if (personalDao.updateRegistroBitacora(registroBitacora)) {
						                ...
						                bitacora.setFechaCambio(new Date());
						                bitacora.setAntes("idCorbatin : " + idCorbatin + " | nomina : " + nomina + " | fechaEntrada : " + fechaEntrada + " | horaEntrada : " + horaEntrada + " | fechaSalida : " + fechaSalida + " | horaSalida : " + horaSalida );
						                bitacora.setDespues(registroBitacora.toString());
						...
						btnReimprimir.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								...
								imprimir(txtNombreEquipo.getText(),txtUsuario.getText(),txtSerial.getText(),cbArea.getSelectedItem().toString(),estatusAux,usuarioNombreF);
							}
						});
						...
						lblNombre.setBounds(348, 45, 80, 26);
						panelFondoParking.add(lblNombre);
						
						txtNombre = new JTextField();
						txtNombre.setEditable(false);
						txtNombre.setColumns(10);
						txtNombre.setBounds(435, 42, 186, 26);
						...
						lblTelefno.setBounds(350, 77, 80, 26);
						panelFondoParking.add(lblTelefno);
						
						txtTelefono = new JTextField();
						txtTelefono.setEditable(false);
						txtTelefono.setColumns(10);
						txtTelefono.setBounds(435, 74, 186, 26);
						panelFondoParking.add(txtTelefono);
						
						//Se agrega un ListSelectionListener a la tabla tableGeneralIt, 
						//lo que permite realizar acciones cuando el usuario selecciona una fila en la tabla
									...
									if (cbArea.getSelectedItem().toString()!= null && cbArea.getSelectedItem().toString() !="") {
										if (txtNombreEquipo.getText()!= null && txtNombreEquipo.getText() !="") {
											if (txtSerial.getText()!= null && txtSerial.getText() !="") {
												if (cbModeloTelefono.getSelectedItem().toString()!= null && cbModeloTelefono.getSelectedItem().toString()!="") {
													...
													if (telefonoAux == null) {
														...
														if (personalDao.crearTelefono(telefono)) {
															...
															if (!cbEstatusTelefono.getSelectedItem().toString().equals("Mantenimiento")) {
																imprimirTelefono(txtNumeroTelefono.getText(), txtUsuarioTelefono.getText(), txtIME.getText(), cbAreaTelefono.getSelectedItem().toString(),telefono.getEstatus(),usuarioNombreF);
															}
															refrescarTelefono();
															...
															cbAreaTelefono.setSelectedIndex(0);
						                                    JOptionPane.showMessageDialog(null, "Se subio el registro", "Aviso", JOptionPane.INFORMATION_MESSAGE);
														}else {
						                                    JOptionPane.showMessageDialog(null, "Error al crear el registro", "Aviso", JOptionPane.ERROR_MESSAGE);
														}
													}else {
														JOptionPane.showMessageDialog(null, "No se pudo subir ya existe un registro con ese numero de serie : "
																+telefonoAux.getIdTelefono()+" con el usuario "+ telefonoAux.getIme()+" "
																		+ "elimine el actual o actualice el numero de serie.", "Aviso", JOptionPane.ERROR_MESSAGE);
						...
						btnReimprimirTelefono.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								...
								if (!cbEstatusTelefono.getSelectedItem().toString().equals("Mantenimiento")) {
									imprimirTelefono(txtNumeroTelefono.getText(), txtUsuarioTelefono.getText(), txtIME.getText(), cbAreaTelefono.getSelectedItem().toString(),Integer.parseInt(estatus),usuarioNombreF);
								}
						...
						/*for (Modelos a: daoPersonal.consultarModelos()) {
							if (a.getTipoModelo().equals("TELEFONO")) {
						...
						btnReimprimirOtros.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								imprimir(txtNombreEquipoOtros.getText(), txtUsuarioOtros.getText(), txtDescripcionOtros.getText(), txtAreaOtros.getText().toString(),1,usuarioNombreF);		
							}
						});
									...
									if (txtAreaOtros.getText().toString()!= null && txtAreaOtros.getText().toString() !="") {
										if (txtNombreEquipoOtros.getText()!= null && txtNombreEquipoOtros.getText() !="") {
											if (txtDescripcionOtros.getText()!= null && txtDescripcionOtros.getText() !="") {
												if (txtDescripcionOtros.getText().toString()!= null && txtDescripcionOtros.getText().toString()!="") {
							...
							public void actionPerformed(ActionEvent arg0) {
								...
								if (configuraciones != null) {
									...
									if (personalDao.actualizarConfiguracion(configuraciones)) {
										JOptionPane.showMessageDialog(null, "Se actualizo tu configuración", "Aviso", JOptionPane.INFORMATION_MESSAGE);
									}else {
										JOptionPane.showMessageDialog(null, "Ocurrio un error al actualizar tu info", "Aviso", JOptionPane.ERROR_MESSAGE);
									}
								}else {
									...
									if (personalDao.crearConfiguracion(configuracionesAux)) {
										JOptionPane.showMessageDialog(null, "Se agrego tu configuración", "Aviso", JOptionPane.INFORMATION_MESSAGE);
									}else {
										JOptionPane.showMessageDialog(null, "Ocurrio un error al agregar tu info", "Aviso", JOptionPane.ERROR_MESSAGE);
									}
								}
							}
						});
						...
						panel_2_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Cuenta", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
						...
						btnActualizarBaseArea.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								...
								if (personalDao.actualizarAreas(area)) {
									//refrescarAreas();
									JOptionPane.showMessageDialog(null, "Se actualizo el registro", "Aviso", JOptionPane.INFORMATION_MESSAGE);
								} else {
						...
						btnEliminarBaseArea.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								...
								/*if (personalDao.eliminarAreas(area)) {
									refrescarAreas();
									JOptionPane.showMessageDialog(null, "Se elimino el registro", "Aviso", JOptionPane.INFORMATION_MESSAGE);
								} else {
									JOptionPane.showMessageDialog(null, "Ocurrio un error", "Aviso", JOptionPane.ERROR_MESSAGE);
								}*/
						...
						btnAgregarBaseModelo.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								...
								if (personalDao.crearModelos(modelo)) {
									refrescarModelos();
									JOptionPane.showMessageDialog(null, "Se creo el registro", "Aviso", JOptionPane.INFORMATION_MESSAGE);
								} else {
									JOptionPane.showMessageDialog(null, "Ocurrio un error", "Aviso", JOptionPane.ERROR_MESSAGE);
								}
							}
