...
public class LeerExcelCPU {
	...
	public LeerExcelCPU(File fileName) {
	...
	public void obtener(List cellDataList) {
		...
		for (int i = 1 ; i< cellDataList.size(); i ++) {
			...
			for (int j = 0;j< cellTempList.size();j++) {
				...
				if (j==0) {
					laptop.setIdLaptop("PC"+Integer.parseInt(stringCellValue.replace(".0", "")));
				...
				if (j==8) {laptop.setObservaciones(null != stringCellValue ? stringCellValue : "" );
				laptop.setEquipo("");}
